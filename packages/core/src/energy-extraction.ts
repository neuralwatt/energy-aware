...
/**
 * Extract energy telemetry from an OpenAI-compatible usage object.
 * Works with any provider that includes energy_joules/energy_kwh in the usage response
 * (e.g., Neuralwatt). Returns undefined when no energy data is present.
 */
